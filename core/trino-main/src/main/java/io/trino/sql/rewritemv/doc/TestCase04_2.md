...
-- mv
create or replace materialized view iceberg.kernel_db01.mv_part04_2 as
...
refresh MATERIALIZED VIEW iceberg.kernel_db01.mv_part04_2;

-- select * from iceberg.kernel_db01.mv_part04_2;
-- drop materialized view iceberg.kernel_db01.mv_part04_2 ;
-- drop table iceberg.kernel_db01.part04_2;
```
